...
<form action="sql_review.php" method="post" name="sql_statement" id="form1">
  ...
  <div align="center">
    ...
    <textarea name="sql_statement" type="text" rows="100" cols="100" value="select * from hechunyang;" size="1000000" style="width:745px;height:300px;color:blue;font-size:24px;border: 5px dashed #FF9933" />
